"""Minimal rect/bounds helpers for pinevex_to_luau.

This is an isolated fork of the layout math needed by the Luau exporter.
It intentionally contains only static rect calculation utilities and has no
dependency on skia-python or the broader ui_engine package.
"""
